...
export interface ApiTourNgoaiNuocTourNgoaiNuoc extends Schema.CollectionType {
  collectionName: 'tour_ngoai_nuocs';
  info: {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::tour-ngoai-nuoc.tour-ngoai-nuoc',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTourTrongNuocTourTrongNuoc extends Schema.CollectionType {
  collectionName: 'tour_trong_nuocs';
  info: {
    singularName: 'tour-trong-nuoc';
    pluralName: 'tour-trong-nuocs';
    displayName: 'Tour Trong N\u01B0\u1EDBc';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::tour-trong-nuoc.tour-trong-nuoc',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
